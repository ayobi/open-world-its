#!/usr/bin/env python3
"""Post-freeze inference correction for the existing frozen open-world model.
...
TEST_KNOWN / TEST_NOVEL are reevaluated with exact-length inference. DEV rows are ignored.
The original checkpoint and split hashes remain enforced.
"""
...
from itsnet.openworld.inference_exact import configure_inference, inference_metadata

from itsnet.openworld.benchmark import VIEWS
from itsnet.openworld.inference_exact import embed_rows_exact as embed_rows
...
def main():
    ...
    print("POST-FREEZE EXACT-LENGTH INFERENCE CORRECTION")
    ...
    report = {
        "evaluation_status": "post_freeze_inference_correction",
    ...
    print("Correction complete. Preserve original results; do not use this rerun for model selection.")
